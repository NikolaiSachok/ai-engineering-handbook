...
2. **RU authorial figures do not port.** The RU/EN canon's protected figures (`canon/ru/_language.md` §6) are language-bound
...
- **Full editorial-team gates in SK**, with the personas configured for the language:
  ...
  - *consistency editor* — against the SK canon (`editorial/canon/sk/_language.md` + the target course ledger, e.g. `rag.md`) + the shared router;
...
- **Phase 1 — Canon bootstrap + glossary.** SK canon in `editorial/canon/sk/` — course-independent rules in
  `_language.md` (voice, typography, bridge policy, anti-bohemism rule) and the course term ledger in
  `rag.md` (recurring block strings, kept-EN defaults, reservations) + the full SK glossary
