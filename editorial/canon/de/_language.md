...
| Durable Execution | **artikellos** | – | – | **RESOLVED.** Kein artikeltragender deutscher Beleg → Präzedenz `Backpressure`. **Pflichtglosse (neu):** „(dauerhafte Ausführung – ein Lauf setzt nach Absturz, Neustart oder Deploy an der letzten gesicherten Stelle fort)". Kompositum: *der Durable-Execution-Modus* |
