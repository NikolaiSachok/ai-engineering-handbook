...
4. **Ein Anglizismus ist hier KEIN Defekt — daraus folgt aber NICHT, dass das englische Wort gewinnt.**
   ...
   **Achtzehn Termini führt das Deutsche belegt selbst** und ein flüssig schreibendes Modell macht sie
   ...
   *der Dienst* (nicht „der Service"), *die Schwärzung* (nicht „die Redaktion"). **Die vollständige Liste
   mit Belegen steht in §1.1.g — vor dem ersten Rendern lesen.**
...
> markiert. Die Zahl „neun" bleibt hier stehen, damit der Zuwachs lesbar ist:
>
...
> > einundzwanzig Zeilen oben lautet die Konsequenz „Wort nicht verwenden". Bei den folgenden lautet sie
...
bei **achtzehn** Termini falsch, jedes Mal in eine Richtung, die sich flüssig und selbstsicher anfühlt. Die
