...
**Feedback loop (observability → eval)** — прод-провалы и фидбэк пользователей становятся новыми кейсами
golden set.
...
**Reasoning–action–observation (ReAct)** — паттерн, где модель чередует шаги рассуждения и действия
(вызовы инструментов), подмешивая результат каждого действия обратно в контекст.
