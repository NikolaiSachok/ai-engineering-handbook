...
# Serving (сервинг) — из Jupyter-ноутбука в сервис
...
[наблюдаемости (observability)](../part-1-rag/cross-cutting/observability.md) из Части I живёт
...
Экосистема на сегодня выглядит так: **vLLM** — де-факто стандарт открытого GPU-сервинга. **[SGLang](https://docs.sglang.io)** —
...
🚧 Второй проход: боевая настройка ASGI (несколько процессов uvicorn), очереди запросов и защита от их
переполнения (backpressure),
внутренности vLLM (планировщик, квантизация), сервинг на нескольких GPU и узлах, планирование GPU в
Kubernetes и автомасштабирование по пропускной способности в токенах, serverless-GPU.
