...
[tooling-ecosystem](../tooling-ecosystem/index.md) will assume those hooks exist.
...
**[New terms](../../glossary.md#serving)**: serving, inference, inference server, SSE (Server-Sent Events), time-to-first-token (TTFT), streaming, continuous batching, PagedAttention, cold start, OpenAI-compatible API.
