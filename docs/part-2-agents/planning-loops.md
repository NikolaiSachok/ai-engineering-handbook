...
## Главный провал — цикл, который не останавливается как надо

У всего этого слоя есть фирменный провал: **цикл не завершается корректно.** Отдай агенту свободу над
...
цикла, приходится **трейсить (trace) всю траекторию** — всю цепочку шагов целиком, — потому что провал может
...
- Фирменный провал слоя — **цикл, который не завершается корректно**, в трёх формах: не останавливается,
