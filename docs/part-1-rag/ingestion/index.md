...
**[New terms](../../glossary.md#ingestion-chunking)**: chunk, chunk overlap, recursive / structural chunking, semantic
...
**[New terms](../../glossary.md#ingestion-chunking)**: embedding, embedding space, bi-encoder, cross-encoder,
...
**[Parsing & advanced embeddings](./deep-dive.md)** — the ingestion layer's second pass: document parsing
(PDF, tables, HTML, OCR, layout-aware extraction), advanced chunking (late chunking, contextual chunk
