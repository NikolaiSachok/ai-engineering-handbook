...
die Schicht, auf die es in der
Praxis ankommt; in Stellenanzeigen erscheint sie als Liste von Werkzeugnamen. Sie trennt „läuft auf meinem
Laptop“ von „läuft unter Last, lässt sich dabei beobachten und bleibt im Kostenrahmen“.

## Was Sie hier finden

- **[Bereitstellung und Betrieb – FastAPI + Docker](./serving/index.md)** – ein Modell oder einen Agenten
  in einen Dienst verpacken: API, Streaming, Container, Inferenz-Engines (*inference server*).
...
Teil I und Teil II vollständig – Bereitstellung und laufender Betrieb setzen voraus, dass der RAG-Agent
selbst bereits steht und verstanden ist.

:::note[Bearbeitungsstand]

Teil III ist abgeschlossen. Jede Lektion ist veröffentlicht – Bereitstellung und Betrieb,
Cloud-KI-Plattformen, das Tooling-Ökosystem und LLMOps –, und jede ist inzwischen ein zweites Mal
durchgearbeitet: Die Vertiefung steht. Folgen Sie auf einer Lektionsseite dem Hinweis „Als Nächstes:
