...
- **Фундамент** (Часть I) лежит под всем циклом: память проекта, правила как код и артефакты как единственный интерфейс между этапами. Всё это должно быть готово ещё до того, как агент напишет первую строку.
...
*Эта карта и есть оглавление.* Верхний ряд — планирование, декомпозиция, реализация, поставка и эксплуатация — охватывает Части II–IV, то есть саму работу. Фундамент — это Часть I. Три уровня зрелости — Часть V. Каждая Часть начинается с того, что говорит, где она на этой карте, и ссылается на неё, — так ты всегда видишь, где находишься.
