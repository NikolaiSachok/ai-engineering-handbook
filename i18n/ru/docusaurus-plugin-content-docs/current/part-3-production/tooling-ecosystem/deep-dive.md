...
Готовый ставится одной командой:

```bash
guardrails hub install hub://guardrails/competitor_check
```

дальше импортируешь его из `guardrails.hub` и пользуешься. Свой устроен несложно, и
...
это выглядит так: ставишь прогоны наступательного тестирования блокирующими проверками в CI или перед
релизом (red-team в promptfoo, red-team-функции платформ, PyRIT из того же углубления) и следишь за долей
успешных атак во времени как за метрикой регрессии. Частота и связка — здесь; устройство инъекций остаётся там.
...
**[Новые термины](../../glossary.md#tooling-ecosystem)**: instrumentation, OpenTelemetry GenAI conventions, safety
