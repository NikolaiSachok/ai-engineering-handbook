...
после релиза — тема [урока про LLMOps](../llmops/index.md).
...
**[Новые термины](../../glossary.md#tooling-ecosystem)**: instrumentation, OpenTelemetry GenAI conventions, safety classifier, red-teaming.

---

:::note[Дальше — вторая часть урока]

**[Развёртывание и связка](./deep-dive.md)** переносит тот же стек на уровень эксплуатации: развёртывание
Langfuse у себя (топология, хранилище, масштабирование), собственные валидаторы для Guardrails AI и то, как
eval-, guardrails- и observability-инструменты — управляемые и открытые — связываются в один стек.

Теорию, которую реализует каждый инструмент, вторая часть не пересказывает, а даёт ссылкой: устройство
метрик Ragas — в [уроке про оценку](../../part-1-rag/cross-cutting/evaluation/deep-dive.md),
GenAI-конвенции OpenTelemetry — в [наблюдаемости](../../part-1-rag/cross-cutting/observability/deep-dive.md),
red-teaming и защита от инъекций — в [guardrails](../../part-1-rag/cross-cutting/guardrails/deep-dive.md), а
оценка траекторий агента — в уроках про [планирование и циклы](../../part-2-agents/planning-loops/deep-dive.md)
и [мультиагентные системы](../../part-2-agents/multi-agent/deep-dive.md).

См. также соседние уроки Части III: [сервинг](../serving/index.md),
[облачные платформы](../cloud-platforms/index.md) и [LLMOps](../llmops/index.md).
