...
# Как удерживать цикл на цели и в границах

В уроке про [Agentic RAG](../agentic-rag/index.md) ты получил цикл: `рассуждение → решение → действие → наблюдение`,
повторять до готовности отвечать. В уроке про [использование инструментов](../tool-use/index.md) выяснилось, что
...
**[Новые термины](../../glossary.md#planning-loops)**: planning, task decomposition, plan-and-execute, re-planning, reflection / self-critique, termination criterion, step budget / iteration limit, loop detection, scratchpad / working memory, non-termination.

---

:::note[Дальше — вторая часть урока]

**[Поиск планов и память](./deep-dive.md)** — глубже про то, как направлять и ограничивать цикл: поиск по
дереву/графу планов, именованные фреймворки рефлексии, политики бюджета и стоимости в проде, архитектуры
памяти для длинных траекторий (эпизодическая против рабочей) и метрики eval на уровне траектории.

См. также: та же механика цикла, но со стороны поиска — [Agentic RAG](../agentic-rag/index.md); как цикл,
его лимиты и восстановление после сбоя выглядят у Claude, OpenAI и Gemini — [завершающий урок части](../real-agents.md).
