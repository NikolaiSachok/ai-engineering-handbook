...
:::note[Дальше: Часть 2 — Глубже]

**→ [Часть 2 — Глубже](./deep-dive.md).** Параллельные вызовы инструментов, форматы схем и строгий
(constrained) декодинг, стратегии обработки ошибок и повторов, цена контекста при десятках инструментов —
механизм, доведённый до мастерского уровня.

Рядом: стандарт подключения инструментов — отдельный урок, [MCP и протоколы агентов](../mcp.md); а как этот
механизм устроен у Claude, OpenAI и Gemini сегодня, показывает капстоун части,
