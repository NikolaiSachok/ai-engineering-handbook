...
- **[Устойчивые прогоны](./durable-runs/index.md)** — кто владеет состоянием прогона, когда чекпойнтер
  встречается с системой учёта, и как возобновлённый прогон не платит дважды за уже сделанную работу.
...
циклы, мультиагентные системы, фреймворки оркестрации, устойчивые прогоны, MCP и финальный разбор реальных
агентов (Claude, OpenAI, Gemini). 🚧 Впереди второй проход — углубление каждого слоя (темы в пометках
«Дальше — углубление слоя» на страницах уроков).
