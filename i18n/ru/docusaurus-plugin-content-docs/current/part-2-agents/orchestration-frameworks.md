...
Прошлые уроки собирали агента из примитивов: [цикл](./agentic-rag.md), [инструменты](./tool-use/index.md),
...
А как эти конструкции разложены по Claude, OpenAI и Gemini, сводит воедино таблица завершающего урока части:
