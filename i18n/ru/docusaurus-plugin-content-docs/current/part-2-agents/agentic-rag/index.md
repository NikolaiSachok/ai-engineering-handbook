...
- **Многошаговые (multi-hop) вопросы.** «Кто руководит отделом, выпустившим политику X?» Одним поиском не
  ...
  строится на результате первого. Статический конвейер физически не умеет сделать этот второй шаг. Декомпозиция — самый
  дешёвый способ отвечать на многошаговые вопросы: ей не нужны ни отдельный проход извлечения по всему
  корпусу, ни схема. Поэтому урок про
  [структурированные знания](../../part-1-rag/structured-knowledge/index.md) и настаивает на том, что граф
  знаний надо оправдывать *другим* классом вопросов, а не этим.
...
**[Новые термины](../../glossary.md#agentic-rag)**: Agentic RAG, agent loop, ReAct (Reasoning + Acting),
...
См. также: как направлять и ограничивать агентный цикл в целом — [Планирование и циклы](../planning-loops/index.md);
