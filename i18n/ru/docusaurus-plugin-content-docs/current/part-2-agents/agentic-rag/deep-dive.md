...
```mermaid
flowchart TB
    R1["Заход 1: поиск"] --> D1["Находка + источник"]
    D1 --> R2["Заход 2: находка + новый поиск"]
    R2 --> D2["Находка + источник"]
    D2 --> R3["Заход 3: находки + поиск"]
    R3 --> Ans["Ответ с источником"]
```
...
**[Новые термины](../../glossary.md#agentic-rag)**: Self-RAG, corrective RAG (CRAG), adaptive RAG, retrieval budget, sufficient context.
