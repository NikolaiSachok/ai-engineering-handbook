...
До сих пор каждый урок Части II строил одного агента. В уроке про [Agentic RAG](../agentic-rag/index.md)
появился цикл; в уроке про [использование инструментов](../tool-use/index.md) — инструменты, которые этот цикл
дёргает; в уроке про [планирование и циклы](../planning-loops/index.md) — как направить цикл на цель и заставить
...
**[Новые термины](../../glossary.md#multi-agent)**: multi-agent system, orchestrator / supervisor, worker / sub-agent, handoff, agent chain, critic / debate.

---

:::note[Дальше — вторая часть урока]

**[Протоколы и координация](./deep-dive.md)** — глубже про то, как команда агентов на самом деле
координируется и как удержать её работающей и по средствам: конкретные протоколы обмена и схемы сообщений,
архитектуры общей памяти (blackboard), паттерны назначения ролей и переговоров, eval мультиагентной системы
со сшивкой траектории по агентам и политики контроля стоимости для команд агентов.

См. также: как оркестратор и изолированные исполнители собраны у Claude, OpenAI и Gemini —
[завершающий урок части](../real-agents.md); общий слой управления циклом и бюджетом, на котором эти команды
стоят, — [планирование и циклы](../planning-loops/index.md).
