...
# Видеть, что система делает в проде
...
**[Новые термины](../../../glossary.md#observability)**: observability, trace / span, RAG tracing, cost per
...
**[Сэмплирование, SLO и бюджеты](./deep-dive.md)** — второй проход слоя наблюдаемости: стратегии
сэмплирования трейсов (head, tail, priority) и приватность в логах (PII, срок хранения); дашборды качества,
пороги алертов и SLO для LLM-системы; как по трейсам возвести регрессию к её причине; и поштучный учёт
токенов с бюджетами латентности (p50/p95) и стоимости.
