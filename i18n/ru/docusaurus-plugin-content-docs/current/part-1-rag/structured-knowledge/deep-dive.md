...
flowchart LR
    ...
    P3 -.->|"извлечение утверждений: опционально, по умолчанию выключено"| CL["Утверждения (covariates)"]
```
