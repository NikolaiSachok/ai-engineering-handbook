...
- **Mutácia hranice** — zmeň `<` na `<=` alebo `>` na `>=`. Ide o chyby posunu o jedna — práve na tomto príklade [register únikov](../escape-ledger.md) oddeľuje chybu od triedy — tentoraz však vložené zámerne.
...
Reťazec zoraď podľa **nákladov na znehodnotenie nadväzujúcej práce** — prvá ide tá kontrola, ktorej opravy znehodnotia najviac nadväzujúcej práce. Ide o závislosť, nie o preferenciu: oprava správania mení činnosť obrazovky a môže ovplyvniť aj jej výslednú podobu. Estetické posúdenie vykonané pred ustálením správania preto možno bude treba zopakovať. Ak najprv hodnotíš vzhľad a až potom funkciu, riskuješ, že estetickú kontrolu zaplatíš dvakrát. Ako prvú spusti kontrolu, ktorej opravy najvýraznejšie zasiahnu do všetkých nasledujúcich. Drahšie posudzovanie potom prebehne až nad výsledkom, ktorý sa už prestal meniť.

Aj druhé kritérium vedie väčšinou rovnakým smerom, takže spravidla niet z čoho vyberať. Brány zoraď tiež podľa **nákladov na jeden beh**, od najlacnejšej, aby drahá brána skúmala iba to, čo prešlo všetkými lacnejšími kontrolami. Deterministický grep je okamžitý a stojí zlomok centa; sémantická kontrola vyžaduje volanie modelu; človek je vzácny zdroj z lekcie o [kontrole pri veľkom objeme](../review-at-volume.md). Ak grep spustíš prvý, model ani človek neminú svoj rozpočet na chybu, ktorú mohla bezplatná kontrola dávno zachytiť. Keď sa obe kritériá rozchádzajú, rozhoduje znehodnotenie a náklady na beh sú až druhé v poradí — presne tým je druhý dôsledok nižšie. Zvyčajne však dávajú rovnaký výsledok: lacné a základné kontroly pred drahými a závislými.
...
- **Poradie reťazca určujú náklady:** rozhoduje zoradenie od najviac znehodnocujúcej kontroly, zoradenie od najlacnejšieho behu je až doplnkové kritérium; zvyčajne vedú rovnakým smerom. Preto spúšťaj mechanickú kontrolu pred sémantickou a sémantickú pred estetickou; neskoršie a drahšie posudzovanie tak prebehne až nad výsledkom, ktorý sa prestal meniť.
