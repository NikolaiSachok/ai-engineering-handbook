...
Princíp najnižších oprávnení pokrýva riziká, ktoré si vymenoval. Sandboxing pokrýva zvyšok — a práve v tom zvyšku sú agenti naozaj iní než skripty, lebo ďalšiu akciu agenta ovplyvňuje obsah, ktorý číta. Popis issue, webová stránka či README závislosti môžu niesť text, ktorý model prečíta ako pokyn. Toto je **prompt injection (podstrčený pokyn)** a vo vydaní [OWASP GenAI LLM Top 10 2026](https://genai.owasp.org/), zverejnenom v auguste 2026, nesie označenie LLM01 a je na prvom mieste tretí rok po sebe (`ASSERTED`, poradie podľa zhody komunity); OWASP je komunitný bezpečnostný projekt, nie regulačný orgán, preto rebríček čítaj ako odbornú zhodu, nie ako požiadavku na súlad s predpismi. Nepríjemné je, že spoľahlivo ho nerozpoznáš — škodlivý vstup je iba text a úlohou modelu je brať text vážne. Cieľom návrhu preto nie je dokonalý filter. Cieľom je, aby sa dal prežiť aj *úspešný* pokus: schopnosti agenta majú byť také malé, že ani najhorší podstrčený pokyn nespôsobí trvalú škodu.
