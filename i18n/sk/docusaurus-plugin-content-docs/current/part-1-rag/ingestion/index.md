...
**[Nové pojmy](../../glossary.md#ingestion-chunking)**: chunk, chunk overlap, recursive / structural chunking, semantic chunking, chunk metadata, parent-document (small-to-big) retrieval.
...
**[Nové pojmy](../../glossary.md#ingestion-chunking)**: embedding, embedding space, bi-encoder, cross-encoder, dimensionality, cosine similarity, retrieval-optimised (asymmetric) embeddings, multilingual embeddings, self-hosted vs. API embeddings.
