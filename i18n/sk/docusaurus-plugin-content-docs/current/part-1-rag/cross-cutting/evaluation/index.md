...
**[Nové pojmy](../../../glossary.md#evaluation)**: evaluation, golden set / golden dataset / ground truth, answer relevance, correctness, LLM-as-a-judge, judge bias, offline vs online eval, regression eval, A/B testing.
