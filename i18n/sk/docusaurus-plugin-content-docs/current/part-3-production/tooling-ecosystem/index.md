...
Ako táto slučka žije po vydaní, je predmetom lekcie o [LLMOps](../llmops/).
...
Pozri aj, v Časti III: [serving](../serving/index.md), [cloudové platformy](../cloud-platforms/index.md) a [LLMOps](../llmops/).
